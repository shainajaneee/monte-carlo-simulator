...
<body class="bg-[#0f172a] text-white flex items-center justify-center min-h-screen">
  ...
  <div class="bg-[#1e293b] p-10 rounded-xl shadow-lg w-full max-w-md">
    <h2 class="text-3xl font-bold mb-6 text-center text-[#2563eb]">Login to TradeSim</h2>
    ...
    <p class="text-gray-400 text-center mt-4">
      ...
      <a href="register.php" class="text-[#2563eb] hover:underline">Sign Up</a>
    </p>
  </div>
